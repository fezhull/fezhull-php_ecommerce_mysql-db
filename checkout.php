      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box" required>
               ...
               <option value="paytm">M-pesa</option>
         ...
         <div class="inputBox">
            <span>ZIP CODE :</span>
            <input type="number" min="0" name="pin_code" placeholder="e.g. 00100" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="box" required>
         </div>
      </div>
